...
{
	#ifdef Device_FHGX
	ETH_WritePHYRegister(PHYAddress, 0x17, 0X4021);//RMII主模式已经在硬件设计时完成
	ETH_WritePHYRegister(PHYAddress, 0x13, 0X0006);//选择进入寄存器页6
	ETH_WritePHYRegister(PHYAddress, 0x14, 0x000a);//配置输出50MHz/CLK_OUT		
	
	ETH_WritePHYRegister(PHYAddress, 0x13, 0X0000);//选择进入寄存器页0
	ETH_WritePHYRegister(PHYAddress, 0x18, 0X0000);
	ETH_WritePHYRegister(PHYAddress, 0x19, 0X8021);//配置LED的工作模式
	#endif
}
